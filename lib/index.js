...
try {
    ...
    let runResult = run(workDir, deep, failLicenseRegex, failDependencyRegex, excludeScopes, outputDir, !(0, common_processing_1.isEmpty)(nullToEmpty) ? nullToEmpty.toLowerCase() === 'true' : true);
